...
public class DriversLicense {
    ...
    public void InvalidBirthdayException(int year, int month, int day){

    }

    public void MissingNameException(String nameType){

    }

    public void UnknownGenderCodeException(char genderCode){
